package com.square.tech.safeblooddonors.ui.home.view;
...
import com.square.tech.safeblooddonors.Empty;
import com.square.tech.safeblooddonors.R;
import com.square.tech.safeblooddonors.base.BaseActivity;
...
import com.square.tech.safeblooddonors.databinding.ActivityHomeBinding;
import com.square.tech.safeblooddonors.injection.Injection;
import com.square.tech.safeblooddonors.ui.home.HomeActivityContract;
import com.square.tech.safeblooddonors.ui.home.presenter.HomeActivityPresenter;
import com.square.tech.safeblooddonors.ui.myprofile.MyProfileActivity;
import com.square.tech.safeblooddonors.util.location.LocationUtil;
...
public class HomeActivity extends BaseActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        (mDonorSheet.findViewById(R.id.direction)).setOnClickListener(view -> {
            com.square.tech.safeblooddonors.data.model.Location location = (com.square.tech.safeblooddonors.data.model.Location) view.getTag();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_about:
                Intent about = new Intent(HomeActivity.this, Empty.class);
                startActivity(about);
                break;
